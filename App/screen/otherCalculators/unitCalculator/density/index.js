...
import { densityCalculation } from "./calculationLogic";
...
export default function DensityCalculator() {
    ...
    useEffect(() => {
        ...
        else setRes(densityCalculation(selectedChargeFrom, selectedChargeTo, calc));
    ...
    return (
        ...
        <SafeAreaView style={{ backgroundColor: theme_mode.backgroundColor }}>
            <Header theme_mode={theme_back} tabsShow={false} headingFirst="Density" headingLast="Calculator" />
