...
import { energyCalculation } from "./calculationLogic";
...
export default function EnergyCalculator() {
    ...
    useEffect(() => {
        ...
        else setRes(energyCalculation(selectedChargeFrom, selectedChargeTo, calc));
    ...
    return (
        ...
        <SafeAreaView style={{ backgroundColor: theme_mode.backgroundColor }}>
            <Header theme_mode={theme_back} tabsShow={false} headingFirst="Energy" headingLast="Calculator" />
